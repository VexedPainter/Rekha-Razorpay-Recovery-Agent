"""rekha/ledger/model.py: the step-outcome event-type constants (R1.7.2,
ADR 0025) -- one canonical source shared by the writers
(rekha/executor/saga.py, rekha/executor/recovery.py) and the readers that
classify by them (rekha/rewind/service.py, rekha/cli/causal.py), instead
...
from rekha.ledger.model import (
    EVENT_TYPES,
    STEP_COMMITTED,
    STEP_FAILED,
    STEP_INDETERMINATE,
