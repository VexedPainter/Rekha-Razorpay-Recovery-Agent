...
Rekha's safety path never lets an LLM (or anything else) decide/verdict a
...
approves or rejects anything -- `rekha approvals approve/reject` is the only
...
from rekha.approvals.queue import ApprovalItem
