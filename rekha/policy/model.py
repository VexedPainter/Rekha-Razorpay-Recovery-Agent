...
class MaxAmount(_Strict):
    ...
    Superseded by `rekha/finance/money.py::Money` (ADR 0028). `Cap.max_amount`
...
class Cap(_Strict):
    ...
    `rekha/policy/cumulative.py`, not by `_evaluate_cap` -- see that module.
