...
from rekha.policy.baseline import BaselineStore
from rekha.policy.model import Cap, CapMatch, PolicyDoc, PolicyResult, Verdict
...
def _evaluate_cap(cap: Cap, plan: Plan) -> Verdict | None:
    ...
    if cap.max_amount is not None:
        ...
        # (rekha/finance/mandate.py) pins the permitted currency at the outer
